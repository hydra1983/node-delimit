...
exports.toRows = function(rowStream, loader, options, headerRowHook, dataRowHook) {
	...
	var lineStream = byline(rowStream, { keepEmptyLines: true });
...
exports.getAttributes = function(rowStream, loader, transformer, options) {
	var dataTypes = []
	, headers = []
	, previousDataRow = []
	, i
	...
	return exports.toRows(rowStream, loader, options
...
exports.getData = function(rowStream, loader, transformer, options, ignoreColumns, dataRowHook) {
	var i, len;

	return exports.toRows(rowStream, loader, options, false
	, function dataRowCallback(dataRow) {

		if (exports.isDataRowEmpty(transformer, dataRow)) { return; }
